#!/usr/bin/env bash
# NVMe baseline: serve Qwen3.8-Flash-Next on one RTX PRO 6000 Blackwell (96 GB).
#
...
# file's name means.
#
# For the table in pinned host RAM use ../v1-ram/serve-nvfp4-ram.sh instead. It needs a
